  ...
  Future<void> onLoad() async {
    ...
    if (!isGameLoaded) {
      ...
      final leftButton = ButtonComponent(
          ...
          position: Vector2(fixedResolution.x - 500, fixedResolution.y - 130),
          onPressed: () {
            _player.left();
          },
          onReleased: () {
      ...
      final rightButton = ButtonComponent(
          ...
          anchor: Anchor.center,
          position: Vector2(fixedResolution.x - 350, fixedResolution.y - 130),
          onPressed: () {
            _player.right();
          },
          onReleased: () {
      ...
      final upButton = ButtonComponent(
          button: CircleComponent(
            radius: 40,
            paint: Paint()..color = Colors.red,
          ),
          anchor: Anchor.center,
          position: Vector2(fixedResolution.x - 430, fixedResolution.y - 220),
          onPressed: () {
            _player.up();
          },
          onReleased: () {
      ...
      final downButton = ButtonComponent(
          button: CircleComponent(
            radius: 40,
            paint: Paint()..color = Colors.red,
          ),
          anchor: Anchor.center,
          position: Vector2(fixedResolution.x - 430, fixedResolution.y - 50),
          onPressed: () {
            _player.down();
          },
          onReleased: () {
