            ...
            Consumer<PlayerData>(
              builder: (context, playerData, child) {
                ...
                return Row(
                  ...
                  children: [
                    Text('Ship: ${spaceship.name}',style: const TextStyle(color: Colors.white,fontSize: 20)),

                    Text('Money: ${playerData.money}',style: const TextStyle(color: Colors.white,fontSize: 20)),
                  ],
                );
              },
            ),
            SizedBox(height: MediaQuery.of(context).size.height * 0.05,),
            const Text('Swipe to change ship',style: TextStyle(color: Colors.white,fontSize: 20)),
            SizedBox(
                ...
                slideBuilder: (index) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Text(spaceship.name,style: const TextStyle(color: Colors.white,fontSize: 20)),
                      Text('Speed: ${spaceship.speed}',style: const TextStyle(color: Colors.white,fontSize: 20),),
                      Text('Level: ${spaceship.level}',style: const TextStyle(color: Colors.white,fontSize: 20)),
                      Text('Cost: ${spaceship.cost}',style: const TextStyle(color: Colors.white,fontSize: 20)),
                      Consumer<PlayerData>(
                        builder: (context, playerData, child) {
                          final type =
                          ...
                          return ElevatedButton(
                            ...
                            child: Text(
                              isEquipped
                                  ...
                                  : isOwned
                                      ? 'Select'
                                      : 'Buy',style: const TextStyle(color: Colors.white,fontSize: 20)
                            ),
                          );
                        },
                      ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(
                    MaterialPageRoute(
                      builder: (context) => const Spacescape(),
                    ),
                  );
                },
