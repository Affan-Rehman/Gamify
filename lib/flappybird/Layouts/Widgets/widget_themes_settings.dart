        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              },child: Image.asset("assets/images/0.png",width: 73,height: 70,)),
              GestureDetector(onTap: (){
                setState(() {
                  Str.image = "1";
                  write("background", Str.image);
              ...
              },child: Image.asset("assets/images/1.png",width: 73,height: 70,)),
              GestureDetector(onTap: (){
                setState(() {
                  Str.image = "2";
                  write("background", Str.image);
              ...
              },child: Image.asset("assets/images/2.png",width: 63,height: 66,)),
            ],
          ),
        ],
      ),
